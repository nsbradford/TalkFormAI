    ...
    <>
      <Page pageTitle="Announcing: TalkForm AI" disableWarning={true}>
        <div className="bg-white text-gray-700 flex items-center justify-center p-4">
          <div className="prose prose-lg text-gray-800">
            ...
            <FloatingTextBox text={`Waitlist for my startup: name, email address, company, job title,
      ...
      If they're a software engineer, ask for their GitHub.`} />
          ...
          />
            ...
            <p>TalkForm understand the semantics of what you&rsquo;re asking for, so it&rsquo;s easy to make sure you&rsquo;re always getting the right data:</p>
            <ChatHistory
              messages={[
            ...
            <p>Some concepts are impossible to specify with existing forms, but easy in natural language:</p>
            <ChatHistory
            messages={[
            ...
            <p>Sometimes you might want to dig deeper into a particular area:</p>
            <ChatHistory
            messages={[
            ...
            <p>You can sign up now for free! If you have any questions or want to get in touch, we&rsquo;d love to hear from you - <Link href='/contact'>contact us here</Link>!</p>
          </div>
        </div>
