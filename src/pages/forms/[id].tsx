...
className="rounded-md bg-red-600 text-white px-3 py-2 text-sm font-semibold hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
>
