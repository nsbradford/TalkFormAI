    ...
    <div className="flex justify-center items-center h-screen">
      <div className="flex flex-col items-center justify-center">
        ...
        <h2 className="text-xl font-extrabold md:text-2xl my-8 inline-block ">
          Create and submit forms with chat. <span className='bg-gradient-to-r from-yellow-400 via-pink-400 to-fuchsia-500 bg-clip-text text-transparent'>It just works.</span>
        </h2>
        <Link href="/forms/new">
          Create a form ›
        </Link>
